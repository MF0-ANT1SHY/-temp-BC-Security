...
from squirRL_environment import GymEthEnv
import argparse

env_name = "squirRLenv"
# read from args
parser = argparse.ArgumentParser()
parser.add_argument("-rl", type=str, default="a2c", help="RL algorithm name")
...
class RecordFractionCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        """
        fraction = self.training_env.envs[0].unwrapped.env.reward_fraction

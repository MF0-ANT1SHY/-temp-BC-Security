...
class Train:
    ...
    def start_training(self):
        ...
        while agent.n_game <= self.max_game:
            ...
            state_new, reward, done, _, _ = env.step(state_new, action)
...
if __name__ == '__main__':
    ...
    agent_hyperparams = {
        ...
        # agent module
        "state_space": 11,                      # Should be equal to the length of state vector
    ...
    env_hyperparams = {
        "max_hidden_block": 20,                 # Maximum length of main chain or private chain
        "attacker_fraction": 0.4,               # Also known as alpha
        "follower_fraction": 0.5,               # Also known as gamma
        "dev": 0,                               # NOTE: Not sure what is this
        "random_interval": (0, 0.5),            # NOTE: Not sure what is this
        "know_alpha": False,                    # NOTE: Not sure what is this
        "relative_p": 0.54,                     # NOTE: Not sure what is this
    }

    # Training Hyperparameters
    train_hyperparams = {
        "max_game": 5000,                       # Total training times
        "max_step": 100,                        # Single training step length
